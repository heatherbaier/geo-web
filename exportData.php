...
include 'includes/email_password.php';
...
// convert string to list based on comma
$countries = explode(",", $filters["isos"]); // Example array of selected countries
$indicators = explode(",", $filters["indicators"]); // Example array of selected countries
...
if (in_array("personnel", $indicators)) {
...
file_put_contents($metadataFilename, $countries);
